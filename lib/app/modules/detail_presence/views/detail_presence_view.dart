          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  (presenceData["masuk"]?["in_area"] == true) ? "In area gkfc_tracking_car_multi" : "Outside area gkfc_tracking_car_multi",
                  style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600),
                ),
                SizedBox(height: 14),
                Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  (presenceData["keluar"]?["in_area"] == true) ? "In area gkfc_tracking_car_multi" : "Outside area gkfc_tracking_car_multi",
                  style: TextStyle(color: AppColor.secondary, fontSize: 16, fontWeight: FontWeight.w600),
                ),
                SizedBox(height: 14),
                Text(
